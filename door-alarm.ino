...
// RESTORED: Exactly your original LED logic. It will correctly catch the 50ms window.
...
// KEPT: The buzzer fix that completely detaches the PWM driver when volume is 0 to kill the hum.
